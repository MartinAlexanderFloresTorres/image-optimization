...
import imgHeader from "../../assets/icon.svg";
import imgMobile from "../../assets/iconMobile.ico";
import "./header.css";

const Header = () => {
  const [menu, setMenu] = useState(true);
  const [todasHerramientas, setTodasHerramientas] = useState(true);
  ...
  const handleTodasHerramientas = () => {
    setTodasHerramientas(!todasHerramientas);
    todasHerramientas
      ? (document.getElementById("todas-herramientas").style.display = "flex")
      : (document.getElementById("todas-herramientas").style.display = "none");
  };

  return (
    <header className='header'>
      <img src={imgMobile} alt='logo' className='header__imgMobile' />
      <div className='header__desktop'>
        <img src={imgHeader} alt='logo' className='header__desktop-img' />
        <a href='#'>
          <svg
      ...
      <div className='header__menu'>
        <a
          ...
          onClick={handleTodasHerramientas}
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
        ...
        <a href='#' onClick={handleMenu} className='menu'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
      ...
      <section className='header__flex container'>
        <div className='d-flex'>
          ...
          <section className='header__center'>
            ...
            <section
              className={`header__herramientas ${herramientas ? "open" : ""}`}
            >
              <div className='container'>
                <ul>
                  <li>
                    <h2 className='p-item'>Conversor</h2>
                  </li>
                  <li>
                    <a href='#' className='d-flex p-item'>
                      <svg
                        fill='none'
                        stroke='currentColor'
                        viewBox='0 0 24 24'
        ...
        <div className='header__right'>
          <a href='#' id='login' className='d-flex p-item'>
            <svg
              fill='none'
              stroke='currentColor'
              viewBox='0 0 24 24'
