		...
		<>
			<footer className='footer'>
				<div className='container'>
					<h2 className='d-flex footer__title'>
						<img src='/svg/logo.svg' alt='logo' width={40} height={40} />
						<span>Optimization image</span>
					</h2>
				</div>
				...
				<div className='footer__navigation'>
					<div className='container scroll-1'>
						<ul className='d-flex'>
							<li>
								<a href='#' title='Inicio' className='d-flex'>
									<svg
										fill='none'
										stroke='currentColor'
										viewBox='0 0 24 24'
							...
							<li>
								...
								>
									...
									<span>Conversión de imágenes en línea</span>
								</a>
							</li>
							<svg
								className='footer__arrow'
							...
							<li>
								...
								>
									...
									<span>Convertir una imagen a WebP</span>
								</a>
							</li>
						</ul>
					</div>
