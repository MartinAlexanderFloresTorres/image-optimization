	...
	return (
		<section className='resultado'>
			<div className='cuadro_completo'>
				...
				<div className='cuadro_botones'>
					<div className='botones_contenedor1'>
					...
					<div className='botones_contenedor2'>
						...
						<div className='subconetedor2'>
							<button className='btn2_download'>
								<span id='span1'></span>
								<span id='span2'></span>
								<i>
									<svg
						...
						<div className='subcontenedor3'>
							<a href='' className='btn_enlace'>
								<span id='span1'></span>
								<span id='span2'></span>
								<i>
									<svg
					...
					<div className='botones_contenedor3'>
						<div className='subcontenedor_boton2'>
						...
						<div className='subcontenedor_boton3'>
						...
						<div className='subcontenedor_boton4'>
						...
						<div className='subcontenedor_boton5'>
							<button className='eliminar_btn'>
								<span id='span1'></span>
								<span id='span2'></span>
								<i>
									<svg
						...
						<div className='subcontenedor_boton6'>
